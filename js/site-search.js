(function () {
  ...
  const pages = [
    ...
    { title: "ClickCoach JV Partner Program", url: "/jv/", type: "Page", description: "Become a ClickCoach JV partner, earn 40% commissions, track clicks and sales, get webinar support, and use professional swipe files.", keywords: "jv partner affiliate signup login 40 commission affiliate links clicks sales stats professional swipe files email social media webinar promotion tools groovedigital joint venture" },
    { title: "SlipMeter", url: "/slipmeter/", type: "Page", description: "SlipMeter is a lightweight Mac timer for coaches who need to track prep, follow-up, admin, and client work outside live coaching sessions.", keywords: "slipmeter mac timer time tracking prep follow up admin client work" },
    ...
    { title: "Coaching Software Answers", url: "/resources/coaching-software-answers/", type: "Guide", description: "Direct answers and comparisons for coaches researching client portals, accountability, progress tracking, admin reduction, and coaching software.", keywords: "coaching software answers direct answers and comparisons for coaches researching client portals, accountability, progress tracking, admin reduction, and coaching software. coaching software answers client portal accountability progress proof comparison admin tools" },
    { title: "What Software Do Coaches Use to Manage Clients?", url: "/resources/what-software-do-coaches-use-to-manage-clients/", type: "Client management", description: "A clear answer for coaches comparing software to manage clients, sessions, notes, homework, billing, portals, and progress in one place.", keywords: "what software do coaches use to manage clients? a clear answer for coaches comparing software to manage clients, sessions, notes, homework, billing, portals, and progress in one place. coaching software answers client portal accountability progress proof comparison admin tools" },
    { title: "What Is the Best Client Portal for Coaches?", url: "/resources/best-client-portal-for-coaches/", type: "Client portals", description: "What coaches should look for in a client portal, including homework, session summaries, resources, invoices, progress charts, and branded access.", keywords: "what is the best client portal for coaches? what coaches should look for in a client portal, including homework, session summaries, resources, invoices, progress charts, and branded access. coaching software answers client portal accountability progress proof comparison admin tools" },
    { title: "How Do Coaches Track Client Progress?", url: "/resources/how-do-coaches-track-client-progress/", type: "Progress tracking", description: "How coaches can track client progress with goals, session notes, homework, milestones, progress reports, and visible proof.", keywords: "how do coaches track client progress? how coaches can track client progress with goals, session notes, homework, milestones, progress reports, and visible proof. coaching software answers client portal accountability progress proof comparison admin tools" },
    { title: "How Do Coaches Keep Clients Accountable Between Sessions?", url: "/resources/how-do-coaches-keep-clients-accountable-between-sessions/", type: "Accountability", description: "How coaches keep clients accountable between sessions using homework, recurring questions, reminders, follow-up, and visible progress.", keywords: "how do coaches keep clients accountable between sessions? how coaches keep clients accountable between sessions using homework, recurring questions, reminders, follow-up, and visible progress. coaching software answers client portal accountability progress proof comparison admin tools" },
    { title: "How Do Coaching Businesses Reduce Admin Work?", url: "/resources/how-do-coaching-businesses-reduce-admin-work/", type: "Admin", description: "How coaching businesses reduce admin by consolidating notes, scheduling, billing, homework, reporting, client portals, and AI-assisted workflows.", keywords: "how do coaching businesses reduce admin work? how coaching businesses reduce admin by consolidating notes, scheduling, billing, homework, reporting, client portals, and ai-assisted workflows. coaching software answers client portal accountability progress proof comparison admin tools" },
    { title: "What Tools Do Life Coaches Need to Run a Practice?", url: "/resources/what-tools-do-life-coaches-need/", type: "Life coaching tools", description: "A practical list of tools life coaches need for clients, scheduling, notes, homework, accountability, payments, resources, and progress tracking.", keywords: "what tools do life coaches need to run a practice? a practical list of tools life coaches need for clients, scheduling, notes, homework, accountability, payments, resources, and progress tracking. coaching software answers client portal accountability progress proof comparison admin tools" },
    { title: "How Should Coaches Document Session Outcomes?", url: "/resources/how-should-coaches-document-session-outcomes/", type: "Session outcomes", description: "How coaches should document session outcomes with decisions, insights, assignments, milestones, client commitments, and progress proof.", keywords: "how should coaches document session outcomes? how coaches should document session outcomes with decisions, insights, assignments, milestones, client commitments, and progress proof. coaching software answers client portal accountability progress proof comparison admin tools" },
    { title: "How Do Coaches Prove Client Progress?", url: "/resources/how-do-coaches-prove-client-progress/", type: "Progress proof", description: "How coaches prove client progress with notes, homework, milestones, behavior change, reports, testimonials, and client-visible outcomes.", keywords: "how do coaches prove client progress? how coaches prove client progress with notes, homework, milestones, behavior change, reports, testimonials, and client-visible outcomes. coaching software answers client portal accountability progress proof comparison admin tools" },
    { title: "ClickCoach vs Simply.Coach", url: "/resources/clickcoach-vs-simply-coach/", type: "Comparison", description: "A practical comparison of ClickCoach and Simply.Coach for coaches evaluating client portals, accountability, progress proof, billing, and coaching workflow.", keywords: "clickcoach vs simply.coach a practical comparison of clickcoach and simply.coach for coaches evaluating client portals, accountability, progress proof, billing, and coaching workflow. coaching software answers client portal accountability progress proof comparison admin tools" },
    { title: "ClickCoach vs CoachVantage", url: "/resources/clickcoach-vs-coachvantage/", type: "Comparison", description: "Compare ClickCoach and CoachVantage for coaching practice management, client portals, billing, accountability, progress tracking, and AI-supported workflow.", keywords: "clickcoach vs coachvantage compare clickcoach and coachvantage for coaching practice management, client portals, billing, accountability, progress tracking, and ai-supported workflow. coaching software answers client portal accountability progress proof comparison admin tools" },
    { title: "ClickCoach vs LifeCoachHub", url: "/resources/clickcoach-vs-lifecoachhub/", type: "Comparison", description: "Compare ClickCoach and LifeCoachHub for coaches deciding between marketplace-style visibility and a dedicated operating system for running a coaching practice.", keywords: "clickcoach vs lifecoachhub compare clickcoach and lifecoachhub for coaches deciding between marketplace-style visibility and a dedicated operating system for running a coaching practice. coaching software answers client portal accountability progress proof comparison admin tools" },
    { title: "Coaching Software vs HR Performance Platforms", url: "/resources/coaching-software-vs-hr-performance-platforms/", type: "Comparison", description: "How coaching software differs from HR performance platforms like PerformYard when coaches need client portals, session notes, homework, and progress proof.", keywords: "coaching software vs hr performance platforms how coaching software differs from hr performance platforms like performyard when coaches need client portals, session notes, homework, and progress proof. coaching software answers client portal accountability progress proof comparison admin tools" },
